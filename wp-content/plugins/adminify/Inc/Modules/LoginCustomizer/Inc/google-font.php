...
<style type="text/css">
    <?php if (!empty($this->options['jltwp_adminify_customizer_custom_css'])) : ?><?php echo $this->options['jltwp_adminify_customizer_custom_css']; ?><?php endif; ?>
</style>

<script type="text/javascript">
    <?php if (!empty($this->options['jltwp_adminify_customizer_custom_js'])) : ?><?php echo $this->options['jltwp_adminify_customizer_custom_js']; ?><?php endif; ?>
</script>
